    ...
    <>
      ...
      >
        <SheetHeader>
          ...
          <SheetDescription>Created at: {formatTimestamp(source.created_at)}</SheetDescription>
          <SheetDescription>Updated at: {formatTimestamp(source.updated_at)}</SheetDescription>
          <Separator />
          <SheetDescription>Import interval: {source.import_interval} minutes</SheetDescription>
          ...
          <SheetDescription className='flex flex-col'>
            <Label className='text-center w-full'>Selected fields for this rss source</Label>
          </SheetDescription>
